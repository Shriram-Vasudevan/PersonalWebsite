    ...
    >
      ...
      >
        <div className="flex flex-col">
          ...
          {/* Content container - using CSS variables for colors */}
          <div className={`w-full bg-[rgb(var(--background-rgb))] p-4 transition-all duration-300 ${isHovered ? 'bg-[rgba(var(--background-rgb),0.8)]' : ''}`}>
            <div className="flex justify-between items-start mb-1">
              <div className="bg-[rgba(var(--accent-rgb),0.2)] px-2 py-0.5 rounded text-xs text-[rgb(var(--foreground-rgb))] font-semibold">
                NEW
              </div>
            </div>
